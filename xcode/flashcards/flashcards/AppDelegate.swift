...
//                application.applicationSupportsShakeToEdit = true;
    ...
    func getAppData(_ callback: @escaping (_ appData:AppData?) ->Void) -> Void {
        ...
        DataManager.getTopAppsDataFromFileWithSuccess { (data) -> Void in
            ...
            // 1
            do {
                json = try JSONSerialization.jsonObject(with: data as Data, options: JSONSerialization.ReadingOptions()) as? [String: [AnyObject]] as [String : AnyObject]!
            } catch {
                print(error)
                return
            }
